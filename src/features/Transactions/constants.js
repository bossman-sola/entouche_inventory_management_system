...
export const txTypes = [
  { id: "Receipt",     apiType: "receipt",     iconPath: iconPaths.receipt,    iconBg: "#e6faf3", iconColor: "#16a369", desc: "Record items received into inventory." },
  { id: "Transfer",    apiType: "transfer",    iconPath: iconPaths.transfer,   iconBg: "#eef2ff", iconColor: "#4f6ef7", desc: "Move items between different locations." },
  { id: "Adjustment",  apiType: "adjustment",  iconPath: iconPaths.adjustment, iconBg: "#fff7ed", iconColor: "#c27a0a", desc: "Adjust inventory quantities." },
  { id: "Stock Count", apiType: "stock_count", iconPath: iconPaths.stockcount, iconBg: "#f5f3ff", iconColor: "#7c3aed", desc: "Record physical stock count." },
];


export const AUTO_LOGIN_EMAIL = "admin@inventory.local";
export const AUTO_LOGIN_PASSWORD = "Admin@1234";
